...
#There are - Laplacian Derivatives, sobelX and sobelY.
#All these functions have diff. mathematical approach to get rusult.
#All the image in the gray scale
...
lap = cv2.Laplacian(img_gray,cv2.CV_64F,ksize = 1) #also pass kernal size which should be always odd
