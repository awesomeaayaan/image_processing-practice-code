...
_, mask = cv2.threshold(img_gry,70,255,cv2.THRESH_BINARY) #the pixel value less than 50 covert to black and above 5o convet to white so image will be seen clearly
