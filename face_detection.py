# -*- coding: utf-8 -*-
"""
Created on Thu Feb 10 15:52:43 2022
...
import cv2
import numpy
face=cv2.CascadeClassifier(r"D:\\my images\\cascades\\haarcascade_frontalface_default.xml") #for detecting face
eye = cv2.CascadeClassifier(r"D:\my images\cascades\haarcascade_eye.xml") #for detecting eyes

image=cv2.imread(r"C:\Users\Hp\Desktop\image\a.jpg")
