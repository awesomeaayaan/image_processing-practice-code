...
#img = cv2.imread(r"C:\Users\Hp\Desktop\test.jpg.JPG")
#img = cv2.resize(img,(600,700))

#img = np.zeros([512,512,3],np.uint8)*255#to draw black screen
img = np.ones([512,512,3],np.uint8)*255#for white image
